...
% This script configure the device
% *************************************************
...
#USER PARAMETERS
bwmode = 0;				#0: bandwidth max 1.3GHz, 1: bandwidth max 1.8 GHz
...
xmax = 9;				#maximum acquired distance
...
VGAIGain = 18;				#VGA gain (0-33) I channel
var_immediate_update("VGAIGain");
VGAQGain = 18;				#VGA gain (0-33) Q channel
